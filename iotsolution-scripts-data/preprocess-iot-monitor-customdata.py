...
#	  // check for payload  'uid=subject.reference,filter:resourceType=MedicationAdministration,payload=payload.payload~\
     ...
     jsoncriteria='uid=properties.OBJECTID,filter:allrecords~\
subtopics=properties.Gender_Drv2~\
values=properties.Totalinjuries~\
identifiers=properties.Traveldirection_Two~\
datetime=properties.DateTime~\
msgid=properties.Incidentid~\
latlong=lat:long'     
